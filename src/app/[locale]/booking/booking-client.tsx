...
export function BookingClient() {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const serviceName = serviceKey ? t(`service_options.${serviceKey}`) : "";
    ...
    window.open(`https://wa.me/50765358376?text=${encodeURIComponent(lines)}`, "_blank");
    setSubmitted(true);
  }
                    ...
                    <div>
                      ...
                      <div className="flex">
                        <select
                          ...
                          className="px-2 py-3 rounded-l-xl border border-r-0 border-border bg-background text-foreground text-sm outline-none cursor-pointer"
                        >
